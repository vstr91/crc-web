 ...
 */
class PontoInteresseSugestaoRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function listarTodosRESTAdmin($limite = null, $dataUltimoAcesso){
        $qb = $this->createQueryBuilder('p')
                ->select('p.id, p.ativo, p.dataCadastro, p.dataRecebimento, '
                        ...
                        . 'IDENTITY(p.pontoInteresse) AS pontoInteresse, p.nome, p.slug, p.imagem, '
                        . 'p.latitude, p.longitude, p.descricao, p.observacao, p.dataInicial, '
                        . 'p.dataFinal, p.permanente, p.status, IDENTITY(p.bairro) AS bairro')
                ->distinct()
