...
/**
 * Description of UsuarioPreferencia
 *
 * @author Almir
 */
 ...
 * UsuarioPreferencia
 *
 * @ORM\Entity(repositoryClass="ApiBundle\Entity\Repository\UsuarioPreferenciaRepository")
 * @ORM\Table(name="usuario_preferencia")
 * @Gedmo\Loggable
 * @ORM\HasLifecycleCallbacks()
 * @UniqueEntity("usuario", message="As preferências do usuário já foram cadastradas")
 * 
 */
class UsuarioPreferencia extends EntidadeBase {
     ...
     * @var string
     *
     * @ORM\Column(name="preferencia", type="string", length=1000)
     * @Assert\NotBlank()
     * @Gedmo\Versioned
     * 
     */
